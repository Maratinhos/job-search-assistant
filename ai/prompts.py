...
Затем анализируется пересечение этих множеств. 
Метрика «процент соответствия» часто вычисляется как отношение совпадающих навыков к общему количеству ключевых требований. 
