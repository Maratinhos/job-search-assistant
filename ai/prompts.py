...
Ограничения:
1. Длина плана созвона 300-400 слов.
2. Не должно содержать контактов, персональных данных.
...
2. **Вопросы от HR (5–10)**. Для каждого вопроса:
   - 🔴 *Красный флаг* — 1–2 слова/словосочетания.
   - ✅ *Пример корректного ответа* — 1-2 слова/1 словосочетания.
   HR-вопросы — только поверхностные (цель подтвердить пункты резюме), без глубоких технических деталей.
3. **Вопросы кандидата к HR (5–10)**. Включить обязательно готовые полные вопросы про: 
...
- Длина эталонных ответов: короткая (5–12 слов).

Ограничения:
- Длина плана технического собеседования 500-600 слов.
- Язык — русский.
...
- Использовать только данные из резюме и вакансии. Если данные отсутствуют — пометить «нетданных». Если есть противоречие — пометить «несоответствие». Не придумывать технологий/проектов.
