...
# Main menu
MAIN_MENU_MESSAGE = "У вас есть резюме и {vacancy_count} вакансий. Выберите действие:"
MAIN_MENU_NO_VACANCIES = "У вас есть резюме, но нет сохраненных вакансий. Загрузите первую."
