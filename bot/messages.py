...
# Main menu
MAIN_MENU_MESSAGE = "У вас есть резюме «{resume_title}». Выберите действие:"
MAIN_MENU_WITH_VACANCY_MESSAGE = "Выбрана вакансия «{vacancy_title}» для резюме «{resume_title}». Выберите действие:"
